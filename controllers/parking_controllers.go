...
func Getnopolbycolour(c echo.Context) error { //sek belum
	...
	if receive_colour != "" {
		...
		return c.JSON(http.StatusOK, models.ParkingResponseMany{
			Code:    http.StatusOK,
			Message: "Success get data all registration by colour",
			Status:  "success",
			Data:    parkingDB,
		})
	}
...
func GetSlotParkingByColour(c echo.Context) error {
	...
	if receive_colour != "" {
		...
		return c.JSON(http.StatusOK, models.ParkingResponseMany{
			Code:    http.StatusOK,
			Message: "Success get data all parking number by colour",
			Status:  "success",
			Data:    parkingDB,
		})
	}
...
func GetSlotParkingByRegistrationNumber(c echo.Context) error {
	var ParkingInput models.ParkingRequest
	c.Bind(&ParkingInput)
